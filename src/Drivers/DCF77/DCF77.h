...
#define DCF77_MIN_TIME_BIT_1		(150 * 10)
#define DCF77_MAX_TIME_BIT_1		(250  * 10)
#define DCF77_MIN_TIME_BIT_0		(50  * 10)
#define DCF77_MAX_TIME_BIT_0		(150  * 10)
#define DCF77_MIN_TIME_BIT_PAUSE	((1000  * 10) - DCF77_MAX_TIME_BIT_1)
#define DCF77_MAX_TIME_BIT_PAUSE	((1000  * 10) - DCF77_MIN_TIME_BIT_0)
#define DCF77_MIN_TIME_SYNC_PAUSE	(1500  * 10)
#define DCF77_MAX_TIME_SYNC_PAUSE	(2500  * 10)
#define DCF77_TIME_OUT				(2500  * 10)
