...
#define DRIVERS_STATE_INIT_APA102		0x0B
#define DRIVERS_STATE_INIT_END			0x0F

#define DRIVERS_STATE_X10_BEGIN1		0x11
#define DRIVERS_STATE_X10_UC			0x12
#define DRIVERS_STATE_X10_DS1307		0x13
#define DRIVERS_STATE_X10_DS18B0		0x14
#define DRIVERS_STATE_X10_WS2801		0x15
#define DRIVERS_STATE_X10_APA102		0x16
#define DRIVERS_STATE_X10_END1			0x19

#define DRIVERS_STATE_X10_BEGIN2		0x20
#define DRIVERS_STATE_X10_WS2812		0x21
#define DRIVERS_STATE_X10_UC_END		0x22
#define DRIVERS_STATE_X10_END2			0x2F
...
#define MAIN_STATE_X10_DRIVERS_BEGIN	0x12
#define MAIN_STATE_X10_LCD				0x13
#define MAIN_STATE_X10_CLOCK			0x14
#define MAIN_STATE_X10_BUTTONS			0x15
#define MAIN_STATE_X10_MODES			0x16
#define MAIN_STATE_X10_DRIVERS_END		0x17
#define MAIN_STATE_X10_END				0x1F
...
#define WHILE_STATE_USART1_BEFORE		0x13
#define WHILE_STATE_USART1_AFTER		0x14
#define WHILE_STATE_USART2_BEFORE		0x15
#define WHILE_STATE_USART2_AFTER		0x16
#define WHILE_STATE_DS13071_BEFORE		0x17
#define WHILE_STATE_DS13071_AFTER		0x18
#define WHILE_STATE_DS13072_BEFORE		0x19
#define WHILE_STATE_DS13072_AFTER		0x20
#define WHILE_STATE_DS13073_BEFORE		0x21
#define WHILE_STATE_DS13073_AFTER		0x22
#define WHILE_STATE_DS13074_BEFORE		0x23
#define WHILE_STATE_DS13074_AFTER		0x24
#define WHILE_STATE_DS13075_BEFORE		0x25
#define WHILE_STATE_DS13075_AFTER		0x26
#define WHILE_STATE_DS13076_BEFORE		0x27
#define WHILE_STATE_DS13076_AFTER		0x28
#define WHILE_STATE_DS13077_BEFORE		0x29
#define WHILE_STATE_DS13077_AFTER		0x30
